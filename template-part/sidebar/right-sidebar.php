                                            ...
                                            <div class="tab-content" style="padding-left:0">
                                                <div class="tab-pane active m-t-20" id="popular">
                                                    <div class="blog-post inner-bottom-30 ">
                                                        <img class="img-responsive" src="<?php get_template_directory_uri();?>/assets/images/blog-post/blog_big_01.jpg" alt="">
                                                    ...
                                                    <div class="blog-post">
                                                        <img class="img-responsive" src="<?php get_template_directory_uri();?>/assets/images/blog-post/blog_big_02.jpg" alt="">
                                                        <h4><a href="blog-details.html">Simple Blog Post</a></h4>
                                                        <span class="review">6 Comments</span>
                                                ...
                                                <div class="tab-pane m-t-20" id="recent">
                                                    <div class="blog-post inner-bottom-30">
                                                        <img class="img-responsive" src="<?php get_template_directory_uri();?>/assets/images/blog-post/blog_big_03.jpg" alt="">
                                                        <h4><a href="blog-details.html">Simple Blog Post</a></h4>
                                                        <span class="review">6 Comments</span>
